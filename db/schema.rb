...
ActiveRecord::Schema[8.0].define(version: 2025_11_24_131826) do
  ...
  create_table "summoner_spells", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_summoner_spells_on_name"
    t.index ["spell_id"], name: "index_summoner_spells_on_spell_id", unique: true
  end
end
